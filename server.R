...
server <- function(input, output, session) {
    ...
    #     names(available_groups) <- display_names
    #     
    #     # 5. Create Checkboxes OR Radio Buttons (Distinct IDs prevent Shiny JS conflicts)
    #     if (isTRUE(input$single_select_mode)) {
    #         radioButtons("viewer_groups_radio", NULL,
    #                      choices = available_groups,
    #                      selected = safe_selection[1], 
    #                      inline = TRUE)
    #     } else {
    #         checkboxGroupInput("viewer_groups_check", NULL,
    #                            choices = available_groups,
